---
title: "Original data - 1st version"
...
The data sets in `data/` are automatically updated every week. However, an initial data set had to be created first, so new lines could be appended after each week. The data sets were created with the following code:
